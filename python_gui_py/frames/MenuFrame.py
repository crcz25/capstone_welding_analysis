...
class MenuFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.sidebar_button_1 = ctk.CTkButton(self, text="Home", command=master.home_button)
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = ctk.CTkButton(self, text="Camera", command=master.camera_button)
